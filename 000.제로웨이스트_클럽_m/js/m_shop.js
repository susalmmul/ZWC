...
if(cate_no < 999) {
    ...
    for(let i=0; i<ITEM_LIST[cate_no].length; i++) {
        let list = `<div class="item_box">
                    <a href="m_deal.html?cate_no=${cate_no}&item_no=${i}">
                        <div class="img_box">
                            <img src="../000.제로웨이스트_클럽/img/shop_page/${MENU_TITLE[cate_no]}/${ITEM_LIST[cate_no][i].src}" alt="메모패드">
                        </div>
...
// console.log(ITEM_LIST[i][j])
            let list = `<div class="item_box">
                    <a href="./m_deal.html?cate_no=${i}&item_no=${j}">
                        <div class="img_box">
                            <img src="../000.제로웨이스트_클럽/img/shop_page/${MENU_TITLE[i]}/${ITEM_LIST[i][j].src}" alt="${ITEM_LIST[i][j].title}">
                        </div>
                        <div class="color_otp_box">
                            <div class="color_opt"></div>
                        </div>
